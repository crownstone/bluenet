...
//APP_PWM_INSTANCE(&_pwmInstance,2);                   // Create the instance "PWM1" using TIMER1.

//PWM::PWM() {
////	pwmTimer = NRF_DRV_TIMER_INSTANCE(2);
//	LOGi("... pwm: %d", pwmTimer.irq);
...
void PWM::switchOff() {
	for (int i = 0; i <_pwmCfg.num_of_channels; ++i) {
		setValue(i, 0);
	}
}
