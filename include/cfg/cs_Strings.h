...
#define FMT_SET_FLOAT_TYPE_VAL                   "Set %d to %f"
#define FMT_SET_FLOAT_VAL                        "Set %s to %f"
#define FMT_SET_STR_TYPE_VAL                     "Set %d to %s"
...
#define FMT_START                                "Start %s ..."
#define FMT_STOP                                 "Stop %s ..."
#define FMT_FAILED_TO                            "Failed to %s (%d)"
#define FMT_ALREADY                              "Already %s"
