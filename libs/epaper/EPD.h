...
#if defined(__MSP430_CPU__) || defined(__MK20DX128__) || defined(NRF51)
#define PROGMEM
#else
...
#if defined(__AVR_ATmega1280__) || defined(__AVR_ATmega_2560__) || defined(__MK20DX128__)
...
typedef function<void(void *buffer, uint16_t line, uint16_t length)> EPD_callback;
...
public:
    ...
    void frame_fn(const EPD_callback& cb, EPD_stage stage);
	...
	void frame_fn_repeat(const EPD_callback& cb, EPD_stage stage);
