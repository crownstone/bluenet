...
public:
    static SwitchBehaviour* resolveSwitchBehaviour(BehaviourHandler& behaviourHandler,
    ...
    /**
     * A very non-standard setup method. This needs to be upgraded to better match what bluenet does.
     * @param behaviourHandler
     * @param presenceHandler
     * @param behaviourStore
     */
    static void setup(BehaviourHandler& behaviourHandler, PresenceHandler* presenceHandler, BehaviourStore* behaviourStore) {
