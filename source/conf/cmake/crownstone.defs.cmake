...
IF(DEFINED NORDIC_HARDWARE_BOARD) 
	...
	ENDIF()
ELSE()
#	MESSAGE(FATAL_ERROR "Nordic hardware board (NORDIC_HARDWARE_BOARD) not defined")
...
#ADD_DEFINITIONS("-DRAM_BLUENET_IPC_LENGTH=${RAM_BLUENET_IPC_LENGTH}")
...
#SET(CS_SERIAL_BOOTLOADER_NRF_LOG_ENABLED        "${CS_SERIAL_BOOTLOADER_NRF_LOG_ENABLED}"      CACHE STRING "CS_SERIAL_BOOTLOADER_NRF_LOG_ENABLED" FORCE)
