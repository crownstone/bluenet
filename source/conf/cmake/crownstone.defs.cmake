...
ADD_DEFINITIONS("-D${NRF_DEVICE} -D${NRF_DEVICE_TYPE} -D${NRF_DEVICE_SERIES}")
...
IF(DEFINED NORDIC_HARDWARE_BOARD)
	ADD_DEFINITIONS("-DBOARD_${NORDIC_HARDWARE_BOARD}")
ENDIF()

IF(NRF_DEVICE_SERIES MATCHES NRF52_SERIES)
	# TODO: Check if this PAN still applies
...
ADD_DEFINITIONS("-DUART_BAUDRATE=${UART_BAUDRATE}")
...
# Add info on mesh version
if(BUILD_MESHING)
	ADD_DEFINITIONS("-DMESH_SDK_VERSION_MAJOR=${MESH_SDK_VERSION_MAJOR}")
	ADD_DEFINITIONS("-DMESH_SDK_VERSION_MINOR=${MESH_SDK_VERSION_MINOR}")
	ADD_DEFINITIONS("-DMESH_SDK_VERSION_PATCH=${MESH_SDK_VERSION_PATCH}")
endif()
...
ADD_DEFINITIONS("-DUICR_INDEX_FAMILY_MARKET_TYPE=${UICR_INDEX_FAMILY_MARKET_TYPE}")
ADD_DEFINITIONS("-DUICR_INDEX_MAJOR_MINOR_PATCH=${UICR_INDEX_MAJOR_MINOR_PATCH}")
ADD_DEFINITIONS("-DUICR_INDEX_PROD_DATE_HOUSING=${UICR_INDEX_PROD_DATE_HOUSING}")
...
ADD_DEFINITIONS("-DFLASH_MICROAPP_PAGES=${FLASH_MICROAPP_PAGES}")

# Add memory options for microapp
ADD_DEFINITIONS("-DRAM_MICROAPP_AMOUNT=${RAM_MICROAPP_AMOUNT}")

# Add support for p2p dfu
ADD_DEFINITIONS("-DBUILD_P2P_DFU=${BUILD_P2P_DFU}")

# Pass information about FDS page count
ADD_DEFINITIONS("-DCS_FDS_VIRTUAL_PAGES=${CS_FDS_VIRTUAL_PAGES}")
ADD_DEFINITIONS("-DCS_FDS_VIRTUAL_PAGES_RESERVED_BEFORE=${CS_FDS_VIRTUAL_PAGES_RESERVED_BEFORE}")
ADD_DEFINITIONS("-DCS_FDS_VIRTUAL_PAGES_RESERVED_AFTER=${CS_FDS_VIRTUAL_PAGES_RESERVED_AFTER}")
