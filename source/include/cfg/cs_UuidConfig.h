...
enum CrownstoneCharacteristicsIDs {
	//	CONTROL_UUID                            = 0x1, // Changed to A, because we the header is different, and we added
...
enum SetupCharacteristicsIDs {
	...
	//	SESSION_NONCE_UUID                      = 0x8, // Changed to E, as we added protocol version.
	//	SETUP_CONTROL_UUID                      = 0x9, // Changed to A, because we the header is different, and we added
	// the result characteristic.
	...
	//	SESSION_DATA_UUID                       = 0xE, // is taken from CrownstonecharacteristicIDs, mentioned here only
	// for completeness' sake
	//	SESSION_DATA_UNENCRYPTED_UUID           = 0xF, // is taken from CrownstonecharacteristicIDs, mentioned here only
	// for completeness' sake
};
