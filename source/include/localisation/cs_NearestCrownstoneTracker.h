...
private:
	constexpr unsigned auto MAX_REPORTS = 10;
	...
	// reporter is always equal to _myId for these.
	report_asset_id_t _personalReportAssetIds[MAX_REPORTS];
	report_asset_mac_t _personalReportAssetMacs[MAX_REPORTS];
	/**
	...
	internal_report_asset_mac_t _winningReportAssetMacs[MAX_REPORTS];
