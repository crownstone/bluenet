...
//	UART_OPCODE_TX_DECRYPTION_FAILED =                10003, // Sent when decryption failed due to missing or wrong key.
	...
	UART_OPCODE_TX_ASSET_RSSI_DATA =                  10108, // Payload: cs_asset_rssi_data_t. Info about an asset a Crownstone on the mesh has forwarded.
	...
	UART_OPCODE_TX_NEAREST_CROWNSTONE_TIMEOUT =       10110, // Payload: cs_nearest_stone_timeout_t. A previously tracked asset hasn't been observed in a while.
