...
cs_ret_code_t getDefault(cs_state_data_t& data, const boards_config_t& boardsConfig) {
	...
	switch (data.type) {
		...
		case CS_TYPE::CONFIG_TAP_TO_TOGGLE_RSSI_THRESHOLD_OFFSET:
			*(TYPIFY(CONFIG_TAP_TO_TOGGLE_RSSI_THRESHOLD_OFFSET)*)data.value =
					g_CONFIG_TAP_TO_TOGGLE_RSSI_THRESHOLD_OFFSET_DEFAULT;
			return ERR_SUCCESS;
		...
		case CS_TYPE::CONFIG_IBEACON_TXPOWER:
			*(TYPIFY(CONFIG_IBEACON_TXPOWER)*)data.value = g_BEACON_RSSI;
			return ERR_SUCCESS;
		case CS_TYPE::CONFIG_TX_POWER: *(TYPIFY(CONFIG_TX_POWER)*)data.value = g_TX_POWER; return ERR_SUCCESS;
		...
		case CS_TYPE::CONFIG_SCAN_BREAK_DURATION:
			*(TYPIFY(CONFIG_SCAN_BREAK_DURATION)*)data.value = g_SCAN_BREAK_DURATION;
			return ERR_SUCCESS;
		case CS_TYPE::CONFIG_BOOT_DELAY: *(TYPIFY(CONFIG_BOOT_DELAY)*)data.value = g_BOOT_DELAY; return ERR_SUCCESS;
		...
		case CS_TYPE::CONFIG_CROWNSTONE_ID:
			*(TYPIFY(CONFIG_CROWNSTONE_ID)*)data.value = g_CONFIG_CROWNSTONE_ID_DEFAULT;
			return ERR_SUCCESS;
		case CS_TYPE::CONFIG_KEY_ADMIN: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_KEY_MEMBER: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_KEY_BASIC: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_KEY_SERVICE_DATA: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_MESH_DEVICE_KEY: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_MESH_APP_KEY: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_MESH_NET_KEY: return ERR_SUCCESS;
		case CS_TYPE::CONFIG_KEY_LOCALIZATION: return ERR_SUCCESS;
		...
		case CS_TYPE::STATE_SWITCHCRAFT_DOUBLE_TAP_ENABLED:
			*(TYPIFY(STATE_SWITCHCRAFT_DOUBLE_TAP_ENABLED)*)data.value = 0;
			return ERR_SUCCESS;
		...
		case CS_TYPE::STATE_ERRORS:
			...
			return ERR_SUCCESS;
		case CS_TYPE::CONFIG_CURRENT_LIMIT: return ERR_NOT_IMPLEMENTED;
		case CS_TYPE::CONFIG_DO_NOT_USE: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_BEHAVIOUR_RULE: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_TWILIGHT_RULE: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_EXTENDED_BEHAVIOUR_RULE: return ERR_NOT_AVAILABLE;
		...
		case CS_TYPE::STATE_DEFAULT_DIM_VALUE:
			*(TYPIFY(STATE_DEFAULT_DIM_VALUE)*)data.value = DEFAULT_DIM_VALUE;
			return ERR_SUCCESS;
		case CS_TYPE::STATE_HUB_MODE: *(TYPIFY(STATE_HUB_MODE)*)data.value = STATE_HUB_MODE_DEFAULT; return ERR_SUCCESS;
		case CS_TYPE::STATE_UART_KEY: memset(data.value, 0, TypeSize(CS_TYPE::STATE_UART_KEY)); return ERR_SUCCESS;
		case CS_TYPE::STATE_ASSET_FILTERS_VERSION:
			*(TYPIFY(STATE_ASSET_FILTERS_VERSION)*)data.value = asset_filters_version_t();
			return ERR_SUCCESS;
		case CS_TYPE::STATE_ASSET_FILTER_32: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_ASSET_FILTER_64: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_ASSET_FILTER_128: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_ASSET_FILTER_256: return ERR_NOT_AVAILABLE;
		case CS_TYPE::STATE_ASSET_FILTER_512: return ERR_NOT_AVAILABLE;
		...
		case CS_TYPE::CMD_SEND_ASYNC_RESULT_TO_BLE: return ERR_NOT_FOUND;
	}
...
PersistenceMode DefaultLocation(CS_TYPE const& type) {
	switch (type) {
		...
		case CS_TYPE::STATE_ASSET_FILTER_512: return PersistenceMode::FLASH;
		case CS_TYPE::STATE_ACCUMULATED_ENERGY:
		case CS_TYPE::STATE_POWER_USAGE:
		case CS_TYPE::STATE_TEMPERATURE:
		case CS_TYPE::STATE_FACTORY_RESET:
		case CS_TYPE::STATE_ERRORS:
		case CS_TYPE::STATE_BEHAVIOUR_MASTER_HASH: return PersistenceMode::RAM;
		...
		case CS_TYPE::EVT_GPIO_UPDATE:
		case CS_TYPE::CMD_RESOLVE_ASYNC_CONTROL_COMMAND:
		case CS_TYPE::CMD_SEND_ASYNC_RESULT_TO_BLE: return PersistenceMode::NEITHER_RAM_NOR_FLASH;
	}
...
PersistenceModeGet toPersistenceModeGet(uint8_t mode) {
	...
	switch (persistenceMode) {
		...
		case PersistenceModeGet::UNKNOWN: return persistenceMode;
	}
...
PersistenceModeSet toPersistenceModeSet(uint8_t mode) {
	...
	switch (persistenceMode) {
		...
		case PersistenceModeSet::UNKNOWN: return persistenceMode;
	}
