...
size16_t TypeSize(CS_TYPE const & type){
	...
	case CS_TYPE::EVT_STORAGE_REMOVE_ALL_TYPES_WITH_ID:
		return sizeof(TYPIFY(EVT_STORAGE_REMOVE_ALL_TYPES_WITH_ID));
	case CS_TYPE::EVT_STORAGE_GC_DONE:
		return 0;
	case CS_TYPE::EVT_STORAGE_FACTORY_RESET:
		return 0;
...
const char* TypeName(CS_TYPE const & type) {
	...
	case CS_TYPE::EVT_STORAGE_REMOVE_ALL_TYPES_WITH_ID: return "EVT_STORAGE_REMOVE_ALL_TYPES_WITH_ID";
