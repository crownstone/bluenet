...
CS_TYPE toCsType(uint16_t type) {
	...
	case CS_TYPE::STATE_PREFERRED_DIM_VALUE:
...
size16_t TypeSize(CS_TYPE const & type) {
	...
	case CS_TYPE::STATE_SWITCHCRAFT_DOUBLE_TAP_ENABLED:
		return sizeof(TYPIFY(STATE_SWITCHCRAFT_DOUBLE_TAP_ENABLED));
	case CS_TYPE::CONFIG_TAP_TO_TOGGLE_ENABLED:
	...
	case CS_TYPE::STATE_MESH_IV_INDEX_V5:
		return sizeof(TYPIFY(STATE_MESH_IV_INDEX_V5));
	case CS_TYPE::STATE_MESH_SEQ_NUMBER_V5:
		return sizeof(TYPIFY(STATE_MESH_SEQ_NUMBER_V5));
	case CS_TYPE::STATE_IBEACON_CONFIG_ID:
	...
	case CS_TYPE::STATE_PREFERRED_DIM_VALUE:
		return sizeof(TYPIFY(STATE_PREFERRED_DIM_VALUE));
	case CS_TYPE::STATE_HUB_MODE:
	...
	case CS_TYPE::CMD_LOCK_SWITCH:
		return sizeof(TYPIFY(CMD_LOCK_SWITCH));
	case CS_TYPE::EVT_STATE_EXTERNAL_STONE:
	...
	case CS_TYPE::CMD_RESOLVE_ASYNC_CONTROL_COMMAND:
		return sizeof(TYPIFY(CMD_RESOLVE_ASYNC_CONTROL_COMMAND));
	case CS_TYPE::CMD_SEND_ASYNC_RESULT_TO_BLE:
		return sizeof(TYPIFY(CMD_SEND_ASYNC_RESULT_TO_BLE));
	} // end switch
