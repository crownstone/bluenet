...
//		}
		memcpy(_scannedDevice.address, scanData->p_metadata->params.scanner.adv_addr.addr, sizeof(_scannedDevice.address)); // TODO: check addr_type and addr_id_peer
		_scannedDevice.addressType = (scanData->p_metadata->params.scanner.adv_addr.addr_type & 0x7F) & ((scanData->p_metadata->params.scanner.adv_addr.addr_id_peer & 0x01) << 7);
		...
		_scannedDevice.data = (uint8_t*)(scanData->p_payload);
