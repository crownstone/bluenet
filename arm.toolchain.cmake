...
# Add characteristics
ADD_DEFINITIONS("-DTEMPERATURE=${TEMPERATURE}")
ADD_DEFINITIONS("-DFIRMWARE=${FIRMWARE}")
ADD_DEFINITIONS("-DCONFIGURATION=${CONFIGURATION}")
ADD_DEFINITIONS("-DCHARACTERISTIC_PWM=${CHARACTERISTIC_PWM}")
ADD_DEFINITIONS("-DSAMPLE_CURRENT=${SAMPLE_CURRENT}")
ADD_DEFINITIONS("-DCURRENT_LIMIT=${CURRENT_LIMIT}")
ADD_DEFINITIONS("-RSSI=${RSSI}")
ADD_DEFINITIONS("-DSCAN_DEVICES=${SCAN_DEVICES}")
ADD_DEFINITIONS("-DTRACK_DEVICES=${TRACK_DEVICES}")
