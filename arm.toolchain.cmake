...
#SET(BUILD_MESHING                      "${BUILD_MESHING}"                      CACHE STRING "BUILD_MESHING")

# Pass variables in defined in the configuration file to the compiler
SET(NRF51822_DIR                                "${NRF51822_DIR}"                   CACHE STRING "NRF51822_DIR")
SET(NORDIC_SDK_VERSION                          "${NORDIC_SDK_VERSION}"             CACHE STRING "NORDIC_SDK_VERSION")
SET(SOFTDEVICE_SERIES                           "${SOFTDEVICE_SERIES}"              CACHE STRING "SOFTDEVICE_SERIES")
SET(SOFTDEVICE_MAJOR                            "${SOFTDEVICE_MAJOR}"               CACHE STRING "SOFTDEVICE_MAJOR")
SET(SOFTDEVICE_MINOR                            "${SOFTDEVICE_MINOR}"               CACHE STRING "SOFTDEVICE_MINOR")
SET(SOFTDEVICE                                  "${SOFTDEVICE}"                     CACHE STRING "SOFTDEVICE")
SET(SOFTDEVICE_NO_SEPARATE_UICR_SECTION         "${SOFTDEVICE_NO_SEPARATE_UICR_SECTION}"   CACHE STRING "SOFTDEVICE_NO_SEPARATE_UICR_SECTION")
SET(APPLICATION_START_ADDRESS                   "${APPLICATION_START_ADDRESS}"      CACHE STRING "APPLICATION_START_ADDRESS")
SET(APPLICATION_LENGTH                          "${APPLICATION_LENGTH}"             CACHE STRING "APPLICATION_LENGTH")
SET(COMPILATION_TIME                            "${COMPILATION_TIME}"               CACHE STRING "COMPILATION_TIME")
SET(HARDWARE_BOARD                              "${HARDWARE_BOARD}"                 CACHE STRING "HARDWARE_BOARD")
SET(HARDWARE_VERSION                            "${HARDWARE_VERSION}"               CACHE STRING "HARDWARE_VERSION")
SET(SERIAL_VERBOSITY                            "${SERIAL_VERBOSITY}"               CACHE STRING "SERIAL_VERBOSITY")
SET(MASTER_BUFFER_SIZE                          "${MASTER_BUFFER_SIZE}"             CACHE STRING "MASTER_BUFFER_SIZE")
SET(DEFAULT_ON                                  "${DEFAULT_ON}"                     CACHE STRING "DEFAULT_ON")
SET(RSSI_ENABLE                                 "${RSSI_ENABLE}"                    CACHE STRING "RSSI_ENABLE")
SET(TX_POWER                                    "${TX_POWER}"                       CACHE STRING "TX_POWER")
SET(ADVERTISEMENT_INTERVAL                      "${ADVERTISEMENT_INTERVAL}"         CACHE STRING "ADVERTISEMENT_INTERVAL")
SET(MIN_ENV_TEMP                                "${MIN_ENV_TEMP}"                   CACHE STRING "MIN_ENV_TEMP")
SET(MAX_ENV_TEMP                                "${MAX_ENV_TEMP}"                   CACHE STRING "MAX_ENV_TEMP")
SET(LOW_POWER_MODE                              "${LOW_POWER_MODE}"                 CACHE STRING "LOW_POWER_MODE")
SET(PWM_ENABLE                                  "${PWM_ENABLE}"                     CACHE STRING "PWM_ENABLE")
SET(FIRMWARE_VERSION                            "${FIRMWARE_VERSION}"               CACHE STRING "FIRMWARE_VERSION")
SET(BOOT_DELAY                                  "${BOOT_DELAY}"                     CACHE STRING "BOOT_DELAY")
SET(SCAN_DURATION                               "${SCAN_DURATION}"                  CACHE STRING "SCAN_DURATION")
SET(SCAN_SEND_DELAY                             "${SCAN_SEND_DELAY}"                CACHE STRING "SCAN_SEND_DELAY")
SET(SCAN_BREAK_DURATION                         "${SCAN_BREAK_DURATION}"            CACHE STRING "SCAN_BREAK_DURATION")
SET(MAX_CHIP_TEMP                               "${MAX_CHIP_TEMP}"                  CACHE STRING "MAX_CHIP_TEMP")
SET(SCAN_FILTER                                 "${SCAN_FILTER}"                    CACHE STRING "SCAN_FILTER")
SET(SCAN_FILTER_SEND_FRACTION                   "${SCAN_FILTER_SEND_FRACTION}"      CACHE STRING "SCAN_FILTER_SEND_FRACTION")
SET(INTERVAL_SCANNER_ENABLED                    "${INTERVAL_SCANNER_ENABLED}"       CACHE STRING "INTERVAL_SCANNER_ENABLED")
SET(CONTINUOUS_POWER_SAMPLER                    "${CONTINUOUS_POWER_SAMPLER}"       CACHE STRING "CONTINUOUS_POWER_SAMPLER")
SET(DEFAULT_OPERATION_MODE                      "${DEFAULT_OPERATION_MODE}"         CACHE STRING "DEFAULT_OPERATION_MODE")
SET(PERSISTENT_FLAGS_DISABLED                   "${PERSISTENT_FLAGS_DISABLED}"      CACHE STRING "PERSISTENT_FLAGS_DISABLED")
SET(MESH_NUM_HANDLES                            "${MESH_NUM_HANDLES}"               CACHE STRING "MESH_NUM_HANDLES")
SET(MESH_BOOT_TIME                              "${MESH_BOOT_TIME}"                 CACHE STRING "MESH_BOOT_TIME")
SET(MESH_ACCESS_ADDR                            "${MESH_ACCESS_ADDR}"               CACHE STRING "MESH_ACCESS_ADDR")
SET(MESH_INTERVAL_MIN_MS                        "${MESH_INTERVAL_MIN_MS}"           CACHE STRING "MESH_INTERVAL_MIN_MS")
SET(MESH_CHANNEL                                "${MESH_CHANNEL}"                   CACHE STRING "MESH_CHANNEL")
SET(NRF_SERIES                                  "${NRF_SERIES}"                     CACHE STRING "NRF_SERIES")
SET(RAM_R1_BASE                                 "${RAM_R1_BASE}"                    CACHE STRING "RAM_R1_BASE")

# Set Attribute table size
SET(ATTR_TABLE_SIZE                             "${ATTR_TABLE_SIZE}"                CACHE STRING "ATTR_TABLE_SIZE")

# Add encryption
SET(ENCRYPTION                                  "${ENCRYPTION}"                     CACHE STRING "ENCRYPTION")
SET(STATIC_PASSKEY                              "${STATIC_PASSKEY}"                 CACHE STRING "STATIC_PASSKEY")

SET(DEVICE_TYPE                                 "${DEVICE_TYPE}"                    CACHE STRING "DEVICE_TYPE")

SET(MESHING                                     "${MESHING}"                        CACHE STRING "MESHING")
SET(BUILD_MESHING                               "${BUILD_MESHING}"                  CACHE STRING "BUILD_MESHING")

# Add iBeacon default values
SET(IBEACON                                     "${IBEACON}"                        CACHE STRING "IBEACON")

SET(BEACON_UUID                                 "${BEACON_UUID}"                    CACHE STRING "BEACON_UUID")
SET(BEACON_MAJOR                                "${BEACON_MAJOR}"                   CACHE STRING "BEACON_MAJOR")
SET(BEACON_MINOR                                "${BEACON_MINOR}"                   CACHE STRING "BEACON_MINOR")
SET(BEACON_RSSI                                 "${BEACON_RSSI}"                    CACHE STRING "BEACON_RSSI")


# Add services
SET(CROWNSTONE_SERVICE                          "${CROWNSTONE_SERVICE}"             CACHE STRING "CROWNSTONE_SERVICE")
SET(INDOOR_SERVICE                              "${INDOOR_SERVICE}"                 CACHE STRING "INDOOR_SERVICE")
SET(GENERAL_SERVICE                             "${GENERAL_SERVICE}"                CACHE STRING "GENERAL_SERVICE")
SET(POWER_SERVICE                               "${POWER_SERVICE}"                  CACHE STRING "POWER_SERVICE")
SET(SCHEDULE_SERVICE                            "${SCHEDULE_SERVICE}"               CACHE STRING "SCHEDULE_SERVICE")

# Add characteristics
SET(CHAR_CONTROL                                "${CHAR_CONTROL}"                   CACHE STRING "CHAR_CONTROL")
SET(CHAR_MESHING                                "${CHAR_MESHING}"                   CACHE STRING "CHAR_MESHING")
SET(CHAR_TEMPERATURE                            "${CHAR_TEMPERATURE}"               CACHE STRING "CHAR_TEMPERATURE")
SET(CHAR_RESET                                  "${CHAR_RESET}"                     CACHE STRING "CHAR_RESET")
SET(CHAR_CONFIGURATION                          "${CHAR_CONFIGURATION}"             CACHE STRING "CHAR_CONFIGURATION")
SET(CHAR_STATE                                  "${CHAR_STATE}"                     CACHE STRING "CHAR_STATE")
SET(CHAR_PWM                                    "${CHAR_PWM}"                       CACHE STRING "CHAR_PWM")
SET(CHAR_SAMPLE_CURRENT                         "${CHAR_SAMPLE_CURRENT}"            CACHE STRING "CHAR_SAMPLE_CURRENT")
SET(CHAR_CURRENT_LIMIT                          "${CHAR_CURRENT_LIMIT}"             CACHE STRING "CHAR_CURRENT_LIMIT")
SET(CHAR_RSSI                                   "${CHAR_RSSI}"                      CACHE STRING "CHAR_RSSI")
SET(CHAR_SCAN_DEVICES                           "${CHAR_SCAN_DEVICES}"              CACHE STRING "CHAR_SCAN_DEVICES")
SET(CHAR_TRACK_DEVICES                          "${CHAR_TRACK_DEVICES}"             CACHE STRING "CHAR_TRACK_DEVICES")
SET(CHAR_RELAY                                  "${CHAR_RELAY}"                     CACHE STRING "CHAR_RELAY")
SET(CHAR_SCHEDULE                               "${CHAR_SCHEDULE}"                  CACHE STRING "CHAR_SCHEDULE")
