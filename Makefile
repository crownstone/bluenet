...
all: build
	...
	@if [ ! -z "${BLUENET_BUILD_DIR}" ]; then echo "Copy binaries to ${BLUENET_BUILD_DIR}"; mkdir -p ${BLUENET_BUILD_DIR}; mkdir -p $(BLUENET_BUILD_DIR)/result; cp $(BLUENET_BUILD_DIR)/*.hex $(BLUENET_BUILD_DIR)/*.bin $(BLUENET_BUILD_DIR)/*.elf $(BLUENET_BUILD_DIR)/result; cp $(BLUENET_BUILD_DIR)/result/* ${BLUENET_BUILD_DIR}; fi
