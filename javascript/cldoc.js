...
cldoc.ImplementedBy = (function(_super) {
  ...
  function ImplementedBy(_at_node) {
    this.node = _at_node;
...
cldoc.GObjectClass = (function(_super) {
  ...
  function GObjectClass(_at_node) {
    this.node = _at_node;
...
cldoc.GObjectInterface = (function(_super) {
  ...
  function GObjectInterface(_at_node) {
    this.node = _at_node;
...
cldoc.GObjectBoxed = (function(_super) {
  ...
  function GObjectBoxed(_at_node) {
    this.node = _at_node;
...
cldoc.GObjectProperty = (function(_super) {
  ...
  function GObjectProperty(_at_node) {
    this.node = _at_node;
